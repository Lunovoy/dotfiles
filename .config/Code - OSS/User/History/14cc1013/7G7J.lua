...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({}, "XF86MonBrightnessUp",  function() 
        awful.spawn("brightnessctl -d amdgpu_bl0 set 5%+ -q", false) 
    end,
    ...
    awful.key({}, "Print", function() 
        awful.util.spawn("spectacle -r", false)
    end,
    {description = "screenshot", group = "control"}),


    awful.key({}, "XF86AudioRaiseVolume",
            function() awful.spawn("amixer -c1 set Master 5%+", false) 
    end,
    ...
    awful.key({}, "XF86AudioMute", function() 
        awful.spawn("pactl set-sink-mute alsa_output.pci-0000_05_00.6.analog-stereo toggle", false) 
    end,
    {description = "mute/unmute volume", group = "control"}),
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ alt,           }, "[",   awful.tag.viewprev,
    {description = "view previous", group = "tag"}),

    awful.key({ alt,           }, "]",  awful.tag.viewnext,
