...
return wibox.widget {
    ...
    {
        {
            button_creator(lock_button, beautiful.bg_3 .."B3", beautiful.fg_color .. "33", dpi(8), 0, beautiful.fg_color .. "33"),
            button_creator(power_button, beautiful.bg_3 .. "B3", beautiful.fg_color .. "33", dpi(8), 0, beautiful.fg_color .. "33"),
